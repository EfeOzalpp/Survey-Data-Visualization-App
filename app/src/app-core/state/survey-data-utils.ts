// src/app-core/state/survey-data-utils.ts
// Pure survey row transforms. Keeping these here makes survey-data-store about flow.
//
// STATE AUDIT (2026-08-21):
// No React state, no call sites in the "who reads this state" sense — pure
// functions imported only by survey-data-store.ts and its test file.
// Call-site/wrapping/re-render questions don't apply here.
